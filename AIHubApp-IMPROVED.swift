...
enum ProviderID: String, CaseIterable, Identifiable, Codable, Hashable {
    case auto, gemini, groq, zai, mistral, cloudflare, vercel, sambaNova, openRouter, siliconFlow, custom
...
final class AIService {
    ...
    private func providerCandidates(hasVisual: Bool, isDocument: Bool, mode: IntelligenceMode, outputMode: OutputMode = .answer) -> [ProviderID] {
        if outputMode == .web {
            ...
            return [.vercel, .gemini, .openRouter, .zai, .custom, .mistral, .sambaNova, .siliconFlow, .cloudflare, .groq]
        }
        if hasVisual || isDocument {
            // Native PDF and real vision providers lead; text-only providers remain late OCR/text fallbacks.
            return [.gemini, .vercel, .zai, .cloudflare, .openRouter, .mistral, .sambaNova, .custom, .groq, .siliconFlow]
        }
        switch mode {
        case .fast: return [.groq, .sambaNova, .zai, .gemini, .mistral, .cloudflare, .siliconFlow, .openRouter, .custom, .vercel]
        case .smart: return [.gemini, .zai, .sambaNova, .groq, .mistral, .cloudflare, .siliconFlow, .openRouter, .custom, .vercel]
        case .deep: return [.vercel, .gemini, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom]
        case .research: return [.gemini, .vercel, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom]
        case .agent: return [.vercel, .gemini, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom]
        case .compare: return [.vercel, .gemini, .zai, .sambaNova, .mistral, .groq, .cloudflare, .openRouter, .siliconFlow, .custom]
        }
    }
