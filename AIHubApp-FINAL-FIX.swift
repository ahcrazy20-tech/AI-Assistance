...
final class AIService {
    ...
    private func providerCandidates(hasVisual: Bool, isDocument: Bool, mode: IntelligenceMode, outputMode: OutputMode = .answer) -> [ProviderID] {
        if outputMode == .web {
            ...
            return [.vercel, .gemini, .deepseek, .cerebras, .openRouter, .zai, .custom, .mistral, .sambaNova, .siliconFlow, .cloudflare, .groq, .nvidiaNIM]
        }
        if hasVisual || isDocument {
            // Native PDF and real vision providers lead; text-only providers remain late OCR/text fallbacks.
            return [.gemini, .vercel, .zai, .cloudflare, .openRouter, .mistral, .sambaNova, .custom, .groq, .siliconFlow, .cerebras, .deepseek, .nvidiaNIM]
        }
        switch mode {
        case .fast: return [.groq, .cerebras, .sambaNova, .zai, .gemini, .mistral, .cloudflare, .siliconFlow, .openRouter, .custom, .vercel, .deepseek, .nvidiaNIM]
        case .smart: return [.gemini, .zai, .sambaNova, .groq, .cerebras, .mistral, .cloudflare, .siliconFlow, .openRouter, .custom, .vercel, .deepseek, .nvidiaNIM]
        case .deep: return [.vercel, .gemini, .deepseek, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom, .cerebras, .nvidiaNIM]
        case .research: return [.gemini, .vercel, .deepseek, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom, .cerebras, .nvidiaNIM]
        case .agent: return [.vercel, .gemini, .deepseek, .zai, .sambaNova, .mistral, .cloudflare, .openRouter, .groq, .siliconFlow, .custom, .cerebras, .nvidiaNIM]
        case .compare: return [.vercel, .gemini, .deepseek, .zai, .sambaNova, .mistral, .groq, .cloudflare, .openRouter, .siliconFlow, .custom, .cerebras, .nvidiaNIM]
        }
    }
